...
async function pong_loop(game_data)
{
    ...
    if (collision(game_data.ball, game_data.leftPaddle))
    {
        game_data.ball.dx *= -1;
    ...
    else if (collision(game_data.ball, game_data.rightPaddle))
    {
        game_data.ball.dx *= -1;
    ...
    game_data.requestId = window.requestAnimationFrame(pong_loop.bind(null, game_data));
}
